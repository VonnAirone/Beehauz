...
export default function StepOne() {
  ...
  async function submitID() {
    try {
      ...
      setLoading(false)
      router.push("/(owner)/(verification)/StepThree")
    }
  }
        ...
        {!imageSource ? (
          <View className='flex-1'>
           <Camera
            ...
            <View className='items-center mt-5'>
              <Text className='text-gray-400'>STEP 2</Text>
            ...
            <View className='items-center mt-5'>
              <Text className='text-base font-medium'>ALIGN YOUR FACE IN THE MIDDLE</Text>
              <Text className='text-xs w-72 text-center'>Make sure your face is inside the box and capture a photo.</Text>
            </View>
          ...
          <View className='flex-1 items-center'>
            <View className='gap-y-2 items-center mb-5 mt-5'>
                <Text className='text-gray-400'>STEP 2</Text>
                <Text className='font-medium text-base'>TAKE A SELFIE</Text>

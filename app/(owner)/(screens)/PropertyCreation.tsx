import { View, Text, TextInput, KeyboardAvoidingView, TouchableWithoutFeedback, Keyboard, Pressable, Alert, ScrollView } from 'react-native'
        ...
        <SafeAreaView className='flex-1 p-5'>
            ...
            <View className='mt-10'>
              ...
              <View className='gap-y-2 mt-2'>
                ...
                {showModal && (
                <View className='shadow-sm rounded-md bg-gray-50  absolute w-full p-3 z-10 top-5'>
                  <Pressable 
                ...
                <View className='flex-row gap-x-2'>
                  ...
                  className='py-2 px-5 rounded-md bg-gray-50 grow'/>
                </View>
              </View>
